        ...
        if (data.success) {
            ...
            data.orders.forEach(order => {
                ...
                tr.innerHTML = `
                    ...
                    <td style="text-align:center;">${order.items.map(item => `<img src="../${item.image || 'assets/Logo.png'}" alt="Product Image" style="width:40px;height:40px;object-fit:cover;border-radius:5px;margin:0 4px;vertical-align:middle;">`).join('')}</td>
